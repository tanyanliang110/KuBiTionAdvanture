var EVENT_DATA = {
    ...
    watchQuest_1:{
        name:'古董学家',
        desc:'古董学家想请你调查一件失落的古董手表。',
        event:'misteryQuest_1',
        d_1:['神秘壶属于一套古董收藏，其中还有一块古董手表。','它很可能还留在贼窝的赃物堆里。'],
        d_2:'请你调查一下贼窝，也许能找到那块手表。',
    },
    watchQuest_2:{
        name:'贼窝调查',
        desc:'调查贼窝底部的赃物堆。',
        want:{traces:1},
        get:{brokenAntiqueWatch:1},
        event:'watchQuest_1',
        d_1:['你根据古董学家的线索调查贼窝底部的赃物堆。'],
        d_2:'你在赃物堆底部找到了一块破损的古董手表。',
    },
    watchQuest_3:{
        name:'古董学家',
        desc:'将破损的古董手表交给古董学家。',
        want:{brokenAntiqueWatch:1},
        event:'watchQuest_2',
        d_1:['这确实是收藏中的古董手表，不过已经损坏了。','交给我吧，我可以尝试修复它。'],
        d_2:'古董学家修复了手表，并将它作为谢礼交给了你。',
    },
    misteryQuest_3:{
        name:'古董学家',
        desc:'喔，请你看一下这个...',
